...
static bool
nat_adresses_change_handler(struct engine_node *node, void *data)
{
...
#undef OVS_NODE
    ...
    engine_add_input(&en_nat_addresses, &en_sb_port_binding, nat_adresses_change_handler);
    engine_add_input(&en_nat_addresses, &en_runtime_data, nat_adresses_change_handler);
